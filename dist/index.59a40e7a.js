...
document.addEventListener("DOMContentLoaded", (e)=>{
    ...
    if (page === "/index.html" || page === "/") console.log(page);
    if (page === "/signUp.html" || page === "/signUp") {
        const form = document.querySelector(".signUp");
        console.log(form);
        form.addEventListener("submit", (e)=>{
            e.preventDefault();
            const formData = new (0, _signUp.SignUp)(form.name.value, form.lastName.value, form.email.value, form.password.value, form.phone.value);
...
},{"../css/style.scss":"1IiJn","../api":"gHpxQ","./signUp":"5WLbD","./signIn":"lQpPB"}],"1IiJn":[function() {},{}],"gHpxQ":[function(require,module,exports) {
...
function signUp(query) {
    if (!query) throw "Please insert type parametr";
    let url = `auth/sign-up`;
    return (0, _axiosDefault.default).post(url, {
        name: `${query.name}`,
...
},{"../utils/axios":"lnTAL","../configs":"35aOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lnTAL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "ApiForImg", ()=>ApiForImg);
parcelHelpers.export(exports, "default", ()=>axios);
var _axios = require("axios");
var _axiosDefault = parcelHelpers.interopDefault(_axios);
var _configs = require("../configs");
var _configsDefault = parcelHelpers.interopDefault(_configs);
const { baseURL , baseImgUrl  } = (0, _configsDefault.default);
const axios = (0, _axiosDefault.default).create({
    baseURL
});
const ApiForImg = (0, _axiosDefault.default).create({
    baseURL: baseImgUrl
});
function getToken(config) {
    const token = localStorage["themovieDB"] ? JSON.parse(JSON.parse(localStorage["themovieDB"])).token : "";
...
ApiForImg.interceptors.request.use((config)=>getToken(config), (error)=>{
    return Promise.reject(error);
});

},{"axios":"jo6P5","../configs":"35aOL","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jo6P5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./../utils.js":"5By4s","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"35aOL":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
exports.default = {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5WLbD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SignUp", ()=>SignUp);
function SignUp(name, lastName, email, password, phone) {
    try {
        this.name = name;
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"lQpPB":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "SignIn", ()=>SignIn);
